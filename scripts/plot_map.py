...
def main():
    # --- CONFIGURATION AREA ---
    FILE_BASE = "LSZH_2019_R14_kinematic_200pts_spatial_5000m_synthetic_1000t"
    AIRPORT_CODE = "LSZH"
    ...
    # Determine the appropriate output directory based on where the data was loaded from
    relative_path = os.path.relpath(X_file_npy, base_dir)
    path_parts = relative_path.split(os.sep)
    
    if "pi_ldm" in path_parts:
        output_dir = os.path.join(base_dir, "pi_ldm", "outputs", "plots")
    else:
